...
const passwordValidators = [
  // First password validator
  {
    ...
    message: 'Password must be at least 4 characters but no more than 35'
  },
...
// methods to compare passowrd upon user login
userSchema.methods.comparePassword = function(password) {
  return bcrypt.compareSync(password, this.password); //return comparison of login password to password in the database (true or false)
